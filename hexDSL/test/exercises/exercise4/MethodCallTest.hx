...
class MethodCallTest
{
	...
	public function setUp() : Void
	{
		...
		_code = BasicStaticXmlCompiler.compile( _applicationAssembler, "exercises/exercise4/methodCall.xml", "episode4" );
		_code.execute();
	}
	...
	public function exercice_4_0() : Void
	{
    ...
    @Test( "create Mr. Meeseeks as 'meeseeks'" )
	public function exercice_4_1() : Void
	{
		Assert.isNotNull( _code.locator.meeseeks );
		Assert.isInstanceOf( _code.locator.meeseeks, Meeseeks );
	}

	@Test( "add 'meeseeks' to 'travelers'" )
	public function exercice_4_2() : Void
	{
	...
	@Test( "time to jump()" )
	public function exercice_4_3() : Void
	{
